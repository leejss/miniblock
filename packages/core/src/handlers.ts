...
export const commandHandlers: {
	[K in EditorCommand["type"]]: CommandHandler<
		Extract<EditorCommand, { type: K }>
	>;
} = {
	updateBlock: updateBlockHandler,
	insertText: insertTextHandler,
	deleteText: deleteTextHandler,
	splitBlock: splitBlockHandler,
	mergeBlockBackward: mergeBlockBackwardHandler,
	deleteBlockBackward: deleteBlockBackwardHandler,
	changeBlockType: changeBlockTypeHandler,
	replaceBlocks: replaceBlocksHandler,
};
